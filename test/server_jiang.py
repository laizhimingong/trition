...
if __name__ == '__main__':
    text="推送测试"
    wecom_cid="wwd2345176b3ebf877"
    wecom_aid="1000002"
    wecom_secret="9ayzyzzmH7Kc2pvN6MYp5_a3J5coWDccrHITtg-iqIo"
    ret=send_to_wecom_markdown(text,wecom_cid,wecom_aid,wecom_secret,wecom_touid='@all')
    print(ret)